...
import static org.touchbit.qa.automatron.resource.spec.PutUserSpec.*;

@Target({ElementType.METHOD})
@Retention(RetentionPolicy.RUNTIME)
@Operation(tags = ACCOUNTING_TAG, summary = I18N_1648863377531, description = I18N_1648863454853, requestBody =
@RequestBody(content = @Content(mediaType = APPLICATION_JSON_VALUE, schema =
@Schema(implementation = PutUserRequestDTO.class))), responses = {
...
public @interface PutUserSpec {

    String EXAMPLE_400 = """
            [{
              "type": "CONTRACT",
              "source": "PutUserRequestDTO.role",
